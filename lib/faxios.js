...
var faxios = function () {
  return function () {
    ...
    var url = function url() {
      ...
      set('url', joinUrl.apply(undefined, [_.configuration.url].concat(params)));
      return _instance;
    };
    ...
    var on = function on(key, _listener) {
    ...
    var use = function use(middleware) {
      if (typeof middleware == 'function') middleware(_instance, _);else if (_middlewares[middleware]) _middlewares[middleware](_instance, _);
      return _instance;
    };
