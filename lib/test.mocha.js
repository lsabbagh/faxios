...
describe('Basics', function () {
    ...
    describe('#on', function () {
        it('.on(event, function)', function (done) {
            faxios().on('complete', function () {}).on('success', function () {}).on('error', function () {}).on('before', function () {}).on('change', function () {}).on(/200/, function () {}).on(/200|400/, function () {}).get('https://jsonplaceholder.typicode.com/posts/1/comments').then(function (res) {
                done();
            }).catch(function (err) {
                done('failed');
            });
