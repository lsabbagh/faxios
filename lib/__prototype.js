...
module.exports = (_module$exports = {
  url: url, set: set, clear: clear, add: add, push: push, build: build, alias: alias, key: key, cancel: cancel, on: on, param: param, data: data,
  ...
  wait: function wait() {
    ...
    return set.call.apply(set, [this, 'wait'].concat(args));
  },
  ...
  debounce: function debounce() {
    ...
    return set.call.apply(set, [this, 'debounce'].concat(args));
  },
