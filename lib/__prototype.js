...
function url() {
  ...
  if (params.length == 1 && (typeof _ === 'undefined' ? 'undefined' : _typeof(_)) == 'object' && typeof url == 'string') {
    var keys = Object.keys(_);
    keys.forEach(function (key) {
      return _this.configuration.url = url.replace(key, _[key]);
    });
    return this;
  }
...
function append() {
  ...
  var _ = params[0];
  if (params.length == 1 && (typeof _ === 'undefined' ? 'undefined' : _typeof(_)) == 'object') {
    var keys = Object.keys(_);
    keys.forEach(function (key) {
      return _this2.configuration.data.append(key, _[key]);
    });
    return this;
  }
  var key = params[0],
...
function build(builder) {
  if (typeof builder == 'function') builder(this);else if (builders[builder]) builders[builder](this);
  return this;
}
